<div id="package-enquire" class="package-enquire collapse">
  <div class="panel-body">
    ...
    <div class="leftfields">
      ...
      <div class="items">
        <label for="message_name">Phone</label>
        <input type="email" placeholder="003612345678" id="message_name" name="message_name" value="<?php echo $_POST['message_name']; ?>">
      </div>
    </div>
    <div class="rightfields">
      <div class="items">
          <label for="message_text">Message*</label>
          <textarea placeholder="Add any question here ..." rows="7" id="message_text" name="message_text"><?php echo $_POST['message_text']; ?></textarea>
      </div>
    </div>
    <div class="actions">
